...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["registro"])) {
        ...
        $permisos = 0; // Por defecto, los nuevos usuarios no son administradores
        ...
        try {
            ...
            $stmt->bindParam(':permisos', $permisos, PDO::PARAM_BOOL);
...
try {
    ...
    $sql = "SELECT * FROM usuarios_adrian LIMIT :offset, :usuariosPorPagina";
    $stmt = $conexion->prepare($sql);
    ...
    // Paginación
    $totalUsuarios = $conexion->query("SELECT COUNT(*) FROM usuarios_adrian")->fetchColumn();
